...
from chatterbot.utils_squad import (convert_examples_to_features,
                                    RawResult, _get_best_indexes, get_final_text, _compute_softmax)

from chatterbot.utils_squad_evaluate import EVAL_OPTS, main as evaluate_on_squad, plot_pr_curve
...
def myModelPredict(text, paragraph):
    ...
    ckpt_name = '/Users/qijia/python_project/my_venv/Lib/site-packages/chatterbot/pretrained_model'
